...
{{--@section('title', 'Edit Parts-Categories')--}}

@section('site-content')
<div class="Page Parts-Categories Edit">
  <div class="container-lg">
    <div class="page-content pt-10">
      <div class="card">
        <div class="card-header page-header bg-purple text-white">
          <h5 class="title mb-0">
            <span class="mr-20">Parts-Category</span>
        ...
        <div class="card-body page-body p-0">
          <div class="partsCategories-edit-area">
            <div class="row">
              <div class="col-md-6">
                <form method="post" action="{{ route('vehicle.parts.category.edit', $category) }}"
                      name="partsCategoryEditForm" id="partsCategoryEditForm" class="partsCategory-form edit mx-md-3 p-20 pb-0">
                  @csrf
