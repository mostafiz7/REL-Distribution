    ...
    <div class="page-content p-10">
      <div class="card">
        <div class="card-header page-header d-flex justify-content-between align-items-center bg-success text-white">
          <h5 class="card-title title lh-1-5 my-0">Add New Employee</h5>

          <div class="">
            <a href="{{ route('employee.all.index') }}" class="btn btn-light btn-sm fw-bold">
              Employee Index
            </a>
          </div>
        </div>
        ...
        <div class="card-body page-body">
          <div class="employee-new-area overlay-scrollbar">
            <form method="post" action="{{ route('employee.new.store') }}" enctype="multipart/form-data" name="addEmployeeForm" id="addEmployeeForm" class="row employee-form new">
              @csrf
